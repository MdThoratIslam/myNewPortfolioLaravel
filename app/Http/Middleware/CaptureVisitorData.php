...
class CaptureVisitorData
{
    ...
    {
        if ($this->isFrontendRoute($request->route()->getName())) {
    ...
    private function isFrontendRoute($routeName)
    {
        // Define frontend route names
        $frontendRoutes = [
            '/',
            'web_site',
            'portfolio_filter',
        ...
        // Check if the requested route name is in the frontend routes array
        return in_array($routeName, $frontendRoutes);
    }
}
