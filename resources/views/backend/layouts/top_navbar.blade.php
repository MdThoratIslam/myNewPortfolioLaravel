                ...
                <ul class="nav navbar-nav">
                                ...
                                <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="media media-sm bg-warning-10 p-4 mb-0">
                                            <div class="media-sm-wrapper">
                                                <a href="user-profile.html">
                                                    <img src="{{asset('public/backend')}}/images/user/user-sm-02.jpg" alt="User Image">
                                                </a>
                                            </div>
                                    ...
                                    <time>10 min ago...</time>...
                                        ...
                                        <div class="media media-sm p-4 mb-0">
                                            <div class="media-sm-wrapper">
                                                <a href="user-profile.html">
                                                    <img src="{{asset('public/backend/')}}images/user/user-sm-03.jpg" alt="User Image">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <a href="user-profile.html">
                                    ...
                                    <div class="tab-pane fade" id="message" role="tabpanel" aria-labelledby="message-tab">
                                        ...
                                        <div class="media media-sm p-4 mb-0">
                                            <div class="media-sm-wrapper">
                                                <a href="user-profile.html">
                                                    <img src="{{asset('public/backend/')}}images/user/user-sm-01.jpg" alt="User Image">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <a href="user-profile.html">
                                    ...
                                    <time>Just now</time>...
                                        ...
                                        <div class="media media-sm p-4 mb-0">
                                            <div class="media-sm-wrapper">
                                                <a href="user-profile.html">
                                                    <img src="{{asset('public/backend/')}}images/user/user-sm-04.jpg" alt="User Image">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <a href="user-profile.html">
                    ...
                    <li class="dropdown user-menu">
                        <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                            <img src="{{asset('public/backend/')}}images/user/user-xs-01.jpg" class="user-image rounded-circle" alt="User Image" />
