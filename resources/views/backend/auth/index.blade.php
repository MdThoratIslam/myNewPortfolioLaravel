...
<head>
    ...
    <link href="{{asset('backend/images/paper-plane.png')}}" rel="icon">
    <link href="{{asset('backend/images/paper-plane.png')}}" rel="apple-touch-icon">
...
<body class="bg-light-gray" id="body" style="background-image: url('{{asset('backend/images/bg_body5.gif')}}');
