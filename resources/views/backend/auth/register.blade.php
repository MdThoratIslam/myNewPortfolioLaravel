                        ...
                        <form action="{{route('register')}}" method="POST">
                          ...
                          <div class="row">
                            <div class="form-group col-md-12 mb-4">
                              <input type="text" class="form-control input-lg {{ $errors->has('name') ? 'is-invalid border-danger' : '' }}" id="name" name="name" aria-describedby="nameHelp" placeholder="Name" required>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group col-md-12 ">
                              <input type="password" class="form-control input-lg {{ $errors->has('password_confirmation') ? 'is-invalid border-danger' : '' }}" id="password_confirmation" placeholder="Confirm Password" name="password_confirmation" required autocomplete="new-password" >
