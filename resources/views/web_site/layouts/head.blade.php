...
<head>
    ...
    <meta content="" name="Md Thorat Islam">
    <!-- Favicons -->
    <link href="{{asset('web_site/assets/img/paper-plane.png')}}" rel="icon">
    <link href="{{asset('web_site/assets/img/paper-plane.png')}}" rel="apple-touch-icon">
    <!-- Google Fonts -->
    ...
    <link href="{{asset('web_site/assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
