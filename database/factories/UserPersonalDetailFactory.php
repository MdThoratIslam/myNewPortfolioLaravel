    ...
    public function definition(): array
    {
        return [
            [
                ...
                'present_upazila_id'    => 1, // Example: generating a random upazila_id between 1 and 10
                ...
                'parmament_upazila_id'  => 1, // Example: generating a random upazila_id between 1 and 10
                'parmament_district_id' => 1, // Example: generating a random district_id between 1 and 20
                'parmament_division_id' => 1, // Example: generating a random division_id between 1 and 5
                ...
                'blood_group_id'        => 8, // Example: generating a random blood_group_id between 1 and 4
